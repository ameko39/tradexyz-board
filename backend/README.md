...
The AI calendar is generated by the backend, cached on disk, and refreshed once per day at 12:00 Beijing time. Fetching raw calendar/TG data does not use AI tokens; only the generation step uses `OPENAI_API_KEY`.
